...
const HISTORY_PREVIEW = [
  { sn: "01", service: "Brake Pad",      vehicle: "Toyota Corolla 2010",    reg: "LGS-6689422", date: "01/09/2025", cost: "₦10,000", provider: "Okorometa Ezekiel" },
  { sn: "02", service: "Suspension",     vehicle: "Mercedes Benz CLA 2018", reg: "LGS-6689422", date: "01/09/2025", cost: "₦10,000", provider: "Okorometa Ezekiel" },
  { sn: "03", service: "Diagnostic Scan",vehicle: "Mercedes Benz GLA 2020", reg: "LGS-6689422", date: "01/09/2025", cost: "₦10,000", provider: "Okorometa Ezekiel" },
  { sn: "04", service: "Engine",         vehicle: "Mercedes Benz GLE 2020", reg: "LGS-6689422", date: "01/09/2025", cost: "₦10,000", provider: "Okorometa Ezekiel" },
];
        ...
        <div className="border rounded-2xl overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50 border-b">
              <tr>
                {["S/N", "Service", "Vehicle", "Date", "Cost", "Service Provider"].map(
                  (col) => (
                    <th
                      key={col}
            ...
            <tbody>
              {HISTORY_PREVIEW.map((row, i) => (
                <tr
                  key={i}
                  className={`${
                    i < HISTORY_PREVIEW.length - 1 ? "border-b" : ""
                  } hover:bg-gray-50 transition-colors`}
                >
                  <td className="px-4 py-3 text-sm text-gray-700">{row.sn}</td>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-700">{row.cost}</td>
